...
#define SIGNAL_ARMING_DEF (uint16_t[64]){60, 940,60, 940, 60, 940,60, 940, 60, 940, 60, 940, 60, 440, 60, 440, 60, 440, 60, 440, 60, 140, 60, 140, 60, 140, 60, 140, 60, 140, 60, 40, 60, 40, 60, 40, 60, 40, 60, 500,800},\
...
#define SIGNAL_ACTION_DISARMED_DEF 	(uint16_t[64]){60, 60, 60, 60, 500},\
							0b10101, \
							0b10101, \
							0b00000, \
							5,\
...
#define SIGNAL_ERROR_PIN_DEF (uint16_t[64]){30, 100,30, 100,30, 100,30,500},\
							0b00000001, \
							0b01010101, \
							0b01010101, \
							8,\
